...
(function (global) {
    ...
    var ADV_BOOK_POINTS = [
        { x: 63, y: 184, id: 6000839, name: '[土]山庄高级天书' },
        { x: 89, y: 140, id: 6000841, name: '[金]山庄高级天书' },
        { x: 147, y: 89, id: 6000842, name: '[木]山庄高级天书' },
        { x: 219, y: 58, id: 6000843, name: '[水]山庄高级天书' },
        { x: 192, y: 190, id: 6000840, name: '[火]山庄高级天书' }
    ];
    var POINT_ARRIVE = 3;
    var GATHER_DIST = 2;
